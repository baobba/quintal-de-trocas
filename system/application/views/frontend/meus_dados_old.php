...
<article class="user-area" id="tabs-1">
	<aside>
		...
		<ul class="side-menu">
			...
			<li><a href="#tab-1-3">Adicionar Brinquedo</a></li>
			<li><a href="#tab-1-4">Minhas Trocas</a></li>
		</ul>
	</aside>
	<div class="column">
                            ...
                            <?php 
                                ...
                                foreach ($toys->result() as $toy) {
                                    ...
                                    echo sprintf('
                                        ...
                                        $base_url . URL_UPLOAD_IMAGE . $toy->image,
                                        $toy->name,
                                        $toy->name,
                                        $base_url . URL_USUARIO_EDITAR_BRINQUEDO . $toy->id,
                                        $base_url . URL_USUARIO_DELETAR_BRINQUEDO . $toy->id);        
                                }
                            ?>
						</ul>
					</div>
