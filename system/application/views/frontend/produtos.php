	...
	<div class="content">
		<div class="item-filter">
			<div class="in">
				<div class="form">
					<form action="<?php echo $url ?>" method="post">
						<fieldset>
							...
							<select id="lbl-33" class="cs-2" title="Selecione..." onchange="this.form.submit()" name="order_by">
				...
				<h2><span class="tbl"><span class="tbl-cell"><span class="tbl-in">Brinquedos disponíveis para troca</span></span></span></h2>
			</div>
		</div>
		<ul class="item-list">
            <?php
