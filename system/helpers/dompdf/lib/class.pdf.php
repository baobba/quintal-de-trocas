...
class  Cpdf {
  ...
  function  addPngFromFile($file, $x, $y, $w =  0, $h =  0) {
    ...
    if  ( ($data =  file_get_contents($file)) ===  false) {
      ...
      $error_msg =  'trouble opening file: '.$file;
    }
    ...
    if  (!$error) {
      ...
      if  (substr($data, 0, 8) !=  $header) {
        ...
        $error_msg =  'this file does not have a valid header';
      }
    }
    ...
    if  (!$error) {
      ...
      while  ($p < $len) {
        ...
        case  'IHDR':
          ...
          if  ($info['compressionMethod'] !=  0) {
            ...
            $error_msg =  'unsupported compression method';
          }
          ...
          if  ($info['filterMethod'] !=  0) {
            ...
            $error_msg =  'unsupported filter method';
          }
      ...
      if (!$haveHeader) {
        ...
        $error_msg =  'information header is missing';
      }
      ...
      if  (isset($info['interlaceMethod']) &&  $info['interlaceMethod']) {
        ...
        $error_msg =  'There appears to be no support for interlaced images in pdf.';
      }
    }
    ...
    if  (!$error &&  $info['bitDepth'] > 8) {
      ...
      $error_msg =  'only bit depth of 8 or less is supported';
    }
    ...
    if  (!$error) {
      ...
      if  ($info['colorType'] !=  2 &&  $info['colorType'] !=  0 &&  $info['colorType'] !=  3) {
        ...
        $error_msg =  'transparancey alpha channel not supported, transparency only supported for palette images.';
      } else {
    ...
    if  ($error) {
      ...
      $this->addMessage('PNG error - ('.$file.') '.$error_msg);
  ...
  function  addImage(&$img, $x, $y, $w =  0, $h =  0, $quality =  75) {
    ...
    if  ( ($data =  file_get_contents($tmpName)) ===  false) {
      ...
      $error_msg =  'trouble opening file';
    }
