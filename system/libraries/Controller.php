...
class Controller extends CI_Base {
	...
	protected function load_js($load_js = array())
	{
	    $this->data['load_js'] = array_merge(
	            $this->data['load_js'],
	            (is_array($load_js) ? $load_js : array($load_js))
	    );
	}
	
	protected function load_css($load_css = array())
	{
	    $this->data['load_css'] = array_merge(
	            $this->data['load_css'],
	            (is_array($load_css) ? $load_css : array($load_css))
	    );
	}
