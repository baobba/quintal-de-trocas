...
class CI_Loader {
	...
	{
	    include_once APPPATH . 'entities' . DIRECTORY_SEPARATOR . $entityName . '.php';
	}
	
	public function formx()
	{
	    include_once APPPATH . '..'  . DIRECTORY_SEPARATOR  . 'libraries' . DIRECTORY_SEPARATOR  . 'formx' . DIRECTORY_SEPARATOR . 'Formx.php';
	}
	
	public function preArray()
	{
	    include_once APPPATH . '..'  . DIRECTORY_SEPARATOR  . 'libraries' . DIRECTORY_SEPARATOR  . 'Prearray.php';
	}
	
	public function uiPagination()
	{
	    include_once APPPATH . '..'  . DIRECTORY_SEPARATOR  . 'libraries' . DIRECTORY_SEPARATOR  . 'UiPagination.php';
	}
