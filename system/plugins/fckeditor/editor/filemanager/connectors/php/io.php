...
function ServerMapFolder( $resourceType, $folderPath, $sCommand )
{
	...
	$serror_msg = CreateServerFolder( $sResourceTypePath ) ;
	if ( $serror_msg != '' )
		SendError( 1, "Error creating folder \"{$sResourceTypePath}\" ({$serror_msg})" ) ;
...
function CreateServerFolder( $folderPath, $lastFolder = null )
{
	...
	if ( !file_exists( $sParent ) )
	{
		...
		$serror_msg = CreateServerFolder( $sParent, $folderPath ) ;
		if ( $serror_msg != '' )
			return $serror_msg ;
	}
