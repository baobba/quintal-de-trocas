...
class ExchangesControllerTest < ActionController::TestCase
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post :create, exchange: { exchange_type: @exchange.exchange_type, status: @exchange.status, toy_from: @exchange.toy_from, toy_to: @exchange.toy_to }
    end
  ...
  test "should update exchange" do
    patch :update, id: @exchange, exchange: { exchange_type: @exchange.exchange_type, status: @exchange.status, toy_from: @exchange.toy_from, toy_to: @exchange.toy_to }
    assert_redirected_to exchange_path(assigns(:exchange))
  end
